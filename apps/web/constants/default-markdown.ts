...
# 마크다운 -> 네이버 블로그 HTML 변환기

MTNB는 마크다운 글을 네이버 블로그에 바로 붙여넣을 수 있는 HTML로 변환합니다.
웹에서 바로 변환할 수 있고, CLI와 라이브러리도 함께 제공해 블로그 작성 자동화에 활용할 수 있습니다.

- 왼쪽에서 마크다운을 작성하세요.
- 오른쪽에서 네이버 블로그용 HTML 미리보기를 확인하세요.
- 서식 복사로 네이버 블로그 에디터에 그대로 붙여넣으세요.

## 마크다운 문법 예시

마크다운은 텍스트 기반의 마크업 언어로, 간단한 문법으로 다양한 서식을 표현할 수 있습니다. 아래 예시를 수정하며 변환 결과를 확인해보세요.
